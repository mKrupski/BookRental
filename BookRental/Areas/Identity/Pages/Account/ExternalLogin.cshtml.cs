...
namespace BookRental.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            {
                var user = new AppUser() { UserName = Input.Email, Email = Input.Email, City = Input.City, StreetAddress = Input.StreetAddress, PostalCode = Input.PostalCode, Name = Input.Name};
